"""Adaptation of the runnable from langchain.

This code will need to be merged into LangChain in some form.

When extracting, we need to allow the model the ability to decline to extract
if there's no relevant information in the test.
"""
import json
