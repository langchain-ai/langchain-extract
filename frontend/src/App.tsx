...
const ExtractionWidget = () => {
  ...
  return (
    ...
    <div className="flex flex-col w-3/4">
      ...
      <textarea placeholder="Text" className="block px-3 mt-2 py-1 textarea textarea-bordered textarea-lg w-full" />
    </div>
       <button className="btn">Run</button>
       </div>
    // <div className="flex-col">
    //   <p>Extract</p>
    //   <textarea placeholder="Text" className="block px-3 mt-2 py-1 textarea textarea-bordered textarea-lg w-full max-w-xs" ></textarea>
    //   <button className="btn">Run</button>
    // </div>
  );
};
